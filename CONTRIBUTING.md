...
***Ask not what CryptLibraryDemo can do for you - ask what you can do for CryptLibraryDemo***
...
2. Include additional information such as:
    ...
    * CryptLibraryDemo Debug-Info containing:
      * Operating System version
      * CryptLibraryDemo version
...
1. Respect existing CryptLibraryDemo coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
